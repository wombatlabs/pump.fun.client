  ...
  return <Box width={'800px'} gap={'48px'} margin={{ top: '32px', bottom: '32px' }}>
    ...
    <Box gap={'16px'}>
      ...
      <Box gap={'8px'}>
        ...
        <Text color={'accentWhite'}>2. A round of competition ends every 1 day at a random time within one hour around midnight, US Pacific Time, if at least one token received any amount of ONE in net liquidity. If there is no such token, the competition round is automatically extended for 1 day.</Text>
