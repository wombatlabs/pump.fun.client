  ...
  return <Box width={'800px'} gap={'48px'} margin={{ top: '32px', bottom: '32px' }}>
    ...
    <Box gap={'16px'}>
      ...
      <Box gap={'8px'}>
        ...
        <Text color={'accentWhite'}>2. A round of competition ends every X days at a random time within one hour around midnight, US Pacific Time, if at least one token received Y amount of ONE in net liquidity. If there is no such token, the competition round is automatically extended for X days.</Text>
    ...
    <Box gap={'16px'}>
      ...
      <Box gap={'8px'}>
        <Text color={'accentWhite'}>1. For each minting and burning, a fee of 50 basis point (0.5%) is deducted from the ONE amount you pay (or would be paid).</Text>
    ...
    <Box gap={'16px'}>
      ...
      <Box gap={'8px'}>
        <Text color={'accentWhite'}>1. Pump One operators have no access to your funds or your tokens. The smart contract only allows the operators to access the fees accumulated, as described above.</Text>
